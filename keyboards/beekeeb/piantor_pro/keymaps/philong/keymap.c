...
void dynamic_macro_play_user(int8_t direction) {
    ...
    switch (index) {
        case 0:
            SEND_STRING_DELAY(SS_TAP(X_END) SS_TAP_CODE_DELAY SS_LSFT(SS_TAP(X_HOME)) SS_TAP_CODE_DELAY DMACRO1_TEXT1 SS_TAP(X_TAB) SS_TAP_CODE_DELAY, 1);
            SEND_STRING_DELAY(SS_TAP(X_END) SS_TAP_CODE_DELAY SS_LSFT(SS_TAP(X_HOME)) SS_TAP_CODE_DELAY DMACRO1_TEXT2 SS_TAP(X_ENTER), 1);
            break;
        case 1:
        default:
            SEND_STRING_DELAY(SS_TAP(X_END) SS_TAP_CODE_DELAY SS_LSFT(SS_TAP(X_HOME)) SS_TAP_CODE_DELAY DMACRO2_TEXT1 SS_TAP(X_TAB) SS_TAP_CODE_DELAY, 1);
            SEND_STRING_DELAY(SS_TAP(X_END) SS_TAP_CODE_DELAY SS_LSFT(SS_TAP(X_HOME)) SS_TAP_CODE_DELAY DMACRO2_TEXT2 SS_TAP(X_ENTER), 1);
    }
}
