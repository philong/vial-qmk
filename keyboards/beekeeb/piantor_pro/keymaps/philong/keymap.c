...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_NAV_NUM] = LAYOUT_split_3x6_3(
        _______,         KC_INS,          KC_HOME,         KC_UP,           KC_END,          KC_PGUP,         KC_EQL,          KC_7,            KC_8,            KC_9,            KC_QUOT,         KC_PPLS,
    ...
    [LAYER_GUI_NUM] = LAYOUT_split_3x6_3(
    ...
    // mods by process_gui_layers(), so the plain keys below combine with them.
    [LAYER_GUI_NAV] = LAYOUT_split_3x6_3(
    ...
    [LAYER_ADJUST] = LAYOUT_split_3x6_3(
        ...
        QK_CLEAR_EEPROM, _______,         _______,         _______,         _______,         TG(LAYER_GAME),  _______,         U_CM_TOGG,       U_PUNCTUATION_MOD_TOGG, _______,  _______,         _______,
                                                           _______,         _______,         _______,         _______,         _______,         _______
    ),
...
static const vial_combo_entry_t default_combos[] = {
    ...
    {{KC_TAB, KC_EQL, KC_NO, KC_NO}, TG(LAYER_GAME)},
};
